...
package com.customdatepicker.date;
...
import com.customdatepicker.HapticFeedbackController;
import com.customdatepicker.R;
import com.customdatepicker.TypefaceHelper;
import com.customdatepicker.Utils;
...
public class DatePickerDialog extends DialogFragment implements
  ...
  public void onClick(View v) {
    ...
    if (v.getId() == R.id.mdtp_date_picker_year) {
      ...
      mYearPickerView.previousYear();
    } else if (v.getId() == R.id.imageViewRight) {
      mYearPickerView.nextYear();
    }
  }
